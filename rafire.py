...
if __name__=="__main__":
	...
	trainset = torchvision.datasets.ImageFolder(root=f"E:/rsna/neural_foraminal_narrowing/New Train or Test Whole Data acidentally deleted full-old_trained data",transform=transform)
